...
${OBJECTDIR}/_ext/429258114/manage_desktop_preferences.o: nbproject/Makefile-${CND_CONF}.mk /home/alexis/workspace/lxkb_config/manage_desktop_preferences.c 
	...
	${RM} $@.d
	$(COMPILE.c) `pkg-config --cflags gtk+-2.0` `pkg-config --cflags libxml-2.0` `pkg-config --cflags gconf-2.0`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/429258114/manage_desktop_preferences.o /home/alexis/workspace/lxkb_config/manage_desktop_preferences.c
