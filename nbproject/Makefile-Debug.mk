...
${OBJECTDIR}/parse_xml_rules.o: nbproject/Makefile-${CND_CONF}.mk parse_xml_rules.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) `pkg-config --cflags gtk+-2.0` `pkg-config --cflags libxml-2.0` `pkg-config --cflags gconf-2.0`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/parse_xml_rules.o parse_xml_rules.c
...
${OBJECTDIR}/parse_xml_rules_nomain.o: ${OBJECTDIR}/parse_xml_rules.o parse_xml_rules.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) `pkg-config --cflags gtk+-2.0` `pkg-config --cflags libxml-2.0` `pkg-config --cflags gconf-2.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/parse_xml_rules_nomain.o parse_xml_rules.c;\
	else  \
